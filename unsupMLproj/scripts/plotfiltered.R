# =============================================================
# clusteringplot_filtered_full.R – 专注于过滤后的 X_dense，绘制所有突变的完整图
# =============================================================
...
fig_dir <- file.path(base_dir, "figures", "filtered_mid")
dir.create(fig_dir, recursive = TRUE, showWarnings = FALSE)

# 读取过滤后的数据和聚类标签
mat_path <- file.path(base_dir, "output", "X_dense_mid.RDS")
...
message("✅ Done plotting full filtered matrix.")
